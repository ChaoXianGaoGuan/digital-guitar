...
| 指板训练 | 大调指型 → 音名 | 选择大调与 Mi/Sol/La/Ti/Re 指型，在高亮区域中识别目标点音名 |
...
- “大调指型 → 音名”支持 12 个大调与 Mi/Sol/La/Ti/Re 五个指型，答案按钮显示当前调内 7 个音名
...
- **大调指型题目**：在标准调弦下按所选大调和 Mi/Sol/La/Ti/Re 指型生成区域，并从区域内调内音随机选择目标点
